...
public class LoginManager : MonoBehaviour {
    ...
    {
        IEnumerator e = DCF.RegisterUser(playerUsername, playerPassword, "[LV1SCORE]0/[LV2SCORE]0/[LV3SCORE]0/[LEVEL]1"); // << Send request to register a new user, providing submitted username and password. It also provides an initial value for the data string on the account.
        while (e.MoveNext())
        {
            yield return e.Current;
        }
